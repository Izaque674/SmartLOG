...
import { db, auth, storage } from '../firebase-config'; // Importe o 'storage'
import { ref, uploadBytesResumable, getDownloadURL } from 'firebase/storage'; // Importe as funções do Storage
    ...
    if (imageFile) {
      ...
      uploadTask.on(
        ...
        (error) => {
          ...
          setIsLoading(false);
          alert("Falha ao salvar a imagem do veículo.");
        },
        () => {
